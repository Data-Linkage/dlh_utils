...
class TestConcat(object):
        def test_expected(self, spark):
            ...
            intended_data = [[None,'Maria','Jones',1,'Maria_Jones','Maria_Jones'],
            ...
            result_df = concat(test_df, 'fullname', sep="_", columns=["firstname",
                                                          "middlename", "lastname"])
...
class TestUnionAll(object):
    def test_expected(self, spark):
        ...
        intended_df = spark.createDataFrame(
            (pd.DataFrame({
                "col1": [None,None,"one","four","five",None,"okay","dfs","few","dfs","xd","xd","xd","xd","xd"],
                "col2": [None, None, "one","four","three",None,None,"fdsa","rew","trt","xd","xd","xd","xd","xd"],
                "col3": ["xd","xd","xd","xd","xd","xd","xd","xd","xd","xd",None, 'okay', 'dfs', 'few', 'dfs']
            })))
...
class TestRenameColumns(object):
    ...
    def test_expected(self, spark):
        ...
        result_df = rename_columns(test_df, rename_dict={"col1": "first", "col2": "second"})
        assert_df_equality(intended_df, result_df)
#########################################################################
...
class TestWindow(object):
    ...
    def test_expected(self, spark):
        ...
        result_df = window(test_df, window=['col1', 'col2'], target='col2', mode='count', alias='new')
        assert_df_equality(intended_df, result_df)
        ...
        result_df2 = window(test_df2, window=['col1'], target='col2', mode='min', alias='new').orderBy('col1', 'col2')
        ...
        result_df3 = window(test_df2, window=['col1'], target='col2', mode='max', alias='new').orderBy("col1",'col2')
        ...
        result_df4 = window(test_df4, window=['col1'], target='col2', mode='max', alias='new').orderBy('col1', 'col2')
