...
class TestStandardiseDate(object):
    ...
    def identify_date_formats(self, spark):
        
        test_df = spark.createDataFrame(
            (pd.DataFrame({
                "dd-MM-yyyy": ['1996/04/15', '14-05-1996', '15-04-1996', '19.03.2021'],
                "dd/MM/yyyy": ['14/05/1996', '05/02/1998', '1996/04/15', '1996.01.01'],
                "dd.MM.yyyy": ['24.05.1996', '1996-05-14', '1996/04/15', '11.11.1996'],
                "ddMMyyyy": ['14051996', '15041998', '1996-04-15', '1996.01.01],
                "yyyy-MM-dd": ['14/05/1996', '1996-05-14', '1996-04-15', '1996.01.01'],
                "yyyy/MM/dd": ['14/05/1996', '1996/05/14', '1996-04-15', '1996/01/01'],
                "yyyy.MM.dd": ['14.05.1996', '1996-05-14', '1996.04.15', '1996.01.01'],
                "yyyyMMdd": ['14/05/1996', '19960514', '199604-5', '1996.01.01'],
                "dd-MM-yy": ['14-05-96', '1996-05-14', '15-01-64', '1996.01.01'],
                "dd.MM.yy": ['14.05.96', '1996-05-14', '15.02.22', '1996.01.01'],
                "dd/MM/yy": ['14/05/96', '1996-05-14', '15/02/22', '1996.01.01'],
            })))

        intended_output = spark.createDataFrame(
            (pd.DataFrame({
                "before": [None, '1996-05-14', '1996-04-15'],
                "after": [None, '1996-05-14', '1996-04-15'],
                "slashed": [None, '14/05/1996', '15/04/1996'],
